...
class Shoe(models.Model):
	...
	name = models.CharField(max_length=None) # Name of shoe
	typeID = models.IntegerField(default=-1) # shoe type ID
	brand = models.CharField(max_length=None) # Name of brand
...
class User(models.Model):
	...
	name = models.CharField(max_length=None) # Name of user
	rating = models.DecimalField(default=-1.0, max_digits=1, decimal_places=2) # rating of user
	shoesOwned = models.ListTextField(base_field=models.IntegerField())
