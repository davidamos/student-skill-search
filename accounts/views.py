		...
		if query:
			...
			for u in result:
				if u.is_searching == True:
					if (query.lower() in u.username.lower()) or (query.lower() in u.description.lower()) or (query.lower() in u.qualities.lower()) or (query.lower() in u.location.lower()) or (query.lower() in u.phone_number.lower()) or (query.lower() in u.profile_email.lower()) or (query.lower() in u.availability.lower()):
